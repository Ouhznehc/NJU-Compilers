...
Exp 
	...
	| Exp PLUS Exp  { $$ = new_symbol("Exp", 5, @$.first_line, 3, $1, $2, $3); }
	| Exp MINUS Exp  { $$ = new_symbol("Exp", 6, @$.first_line, 3, $1, $2, $3); }
	| Exp STAR Exp  { $$ = new_symbol("Exp", 7, @$.first_line, 3, $1, $2, $3); }
	| Exp DIV Exp  { $$ = new_symbol("Exp", 8, @$.first_line, 3, $1, $2, $3); }
	| LP Exp RP { $$ = new_symbol("Exp", 9, @$.first_line, 3, $1, $2, $3); }
	| MINUS Exp %prec NOT { $$ = new_symbol("Exp", 10, @$.first_line, 2, $1, $2); }
	| NOT Exp  { $$ = new_symbol("Exp", 11, @$.first_line, 2, $1, $2); }
